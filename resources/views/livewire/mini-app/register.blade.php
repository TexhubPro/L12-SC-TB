<div class="max-w-sm mx-auto p-4 space-y-4">
    <div class="py-10">
        <form wire:submit="save" class="bg-neutral-800 border border-neutral-700 rounded-xl p-4">
            ...
            <flux:text class="mt-2">Создайте личный кабинет, чтобы отслеживать заказы и пользоваться всеми
                возможностями
                сервиса.</flux:text>
            <div class="space-y-4 mt-5">
                ...
                <flux:button variant="primary" color="blue" class="w-full" type="submit">Регистрация</flux:button>
            </div>
        </form>
        @if ($message)
