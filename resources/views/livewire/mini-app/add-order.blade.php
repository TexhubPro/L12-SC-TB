<div>
    ...
    <form wire:submit="add" class="bg-neutral-800 border border-neutral-700 rounded-xl p-2 mt-4 space-y-3">
        <flux:textarea label="Трек-код" wire:model="trackcode" placeholder="Введите трек-код или трек-коды" rows="auto"
            required />
        <flux:button variant="primary" type="submit" color="blue" class="w-full">Добавить</flux:button>
    </form>
</div>
